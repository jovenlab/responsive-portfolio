    ...
    id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        {serviceData.map(({icon, title, description, link}, index) => (
            <motion.div
                ...
                key={index}
                className="border border-gray-400 rounded-lg px-8 py-12 hover:shadow-[4px_4px_0_#000] cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white flex flex-col h-full">
